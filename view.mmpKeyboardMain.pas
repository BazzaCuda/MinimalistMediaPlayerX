...
function KBProcessKeyStroke(const SS: TSnapshot): TKeyOp;
  ...
  begin
    ...
    case keyUp and keyIs(C) and NOT ctrl and NOT shift  and NOT GS.showingTimeline    of TRUE: result := koToggleControls; end;
    ...
    case keyUp and keyIs(R) and     ctrl                and NOT GS.showingTimeline    of TRUE: result := koToggleRepeat; end;
    case keyUp and keyIs(R) and     ctrl                and     GS.showingTimeline    of TRUE: result := koRenameFile; end;
    case keyUp and keyIs(R) and NOT ctrl                and NOT GS.showingTimeline    of TRUE: result := koRenameFile; end;
