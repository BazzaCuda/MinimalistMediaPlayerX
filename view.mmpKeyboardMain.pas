...
function KBProcessKeyStroke(const SS: TSnapshot): TKeyOp;
  ...
  begin
    ...
    case keyUp and keyIs(P) and NOT ctrl and NOT shift                                                              of TRUE: result := koTogglePlaylist; end;
    case keyUp and keyIs(P) and     ctrl and NOT shift              and NOT  GS.showingTimeline                     of TRUE: result := koToggleFiltering; end;
    case keyUp and keyIs(P) and     ctrl and     shift                                                              of TRUE: result := koPreviewSheet; end;
