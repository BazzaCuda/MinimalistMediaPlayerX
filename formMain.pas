...
begin
  MP.adjustAspectRatioDelayed(SELF, MP.videoWidth, MP.videoHeight);
end;
...
//
////  PL.add(url);
//  PL.add('B:\Movies\_ToGetOrWatch.txt');
//  PL.add('B:\Movies\Blazing Saddles (1974).mp4');
////  PL.add('B:\Images\Map of USA with state and territory names 2-1.png');
