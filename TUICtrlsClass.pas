...
uses
  formSubtitles, mediaInfo, TMediaPlayerClass, commonUtils, progressBar, winApi.messages, TPlaylistClass, system.sysUtils, formCaption, TKeyboardClass, TSysCommandsClass,
