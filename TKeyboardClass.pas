...
uses
  TSysCommandsClass, winApi.windows, TMediaPlayerClass, TMediaInfoClass, formCaption, TPlaylistClass, TUICtrlsClass, consts, TGlobalVarsClass, commonUtils, vcl.forms,
