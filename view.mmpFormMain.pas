...
type
  ...
  protected
    ...
    procedure   WINSkipAnimation  (var msg: TMessage);      message WIN_SKIP_ANIMATION;
...
procedure TMMPUI.WINSkipAnimation(var msg: TMessage);
begin
  case FViewModel = NIL of TRUE: EXIT; end;
  FViewModel.onWINSkipAnimation(msg);
end;
...
procedure TMMPUI.WINTerminate(var msg: TMessage);
begin
  FViewModel := NIL;
  close;
end;
