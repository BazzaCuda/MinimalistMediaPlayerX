...
const
  ...
  WIN_MUTE_UNMUTE       = WM_APP + 2006;
  WIN_PAUSE_PLAY        = WM_APP + 2007;
  WIN_RESIZE            = WM_APP + 2008;
  WIN_SKIP_ANIMATION    = WM_APP + 2009;
  WIN_SKIP_BACKWARDS    = WM_APP + 2010;
  WIN_SKIP_FORWARDS     = WM_APP + 2011;
  WIN_START_OVER        = WM_APP + 2012;
  WIN_SYNC_MEDIA        = WM_APP + 2013;
  WIN_TAB               = WM_APP + 2014;
  WIN_TABTAB            = WM_APP + 2015;
  WIN_TOGGLE_CONTROLS   = WM_APP + 2016;
  WIN_TOGGLE_EDIT_MODE  = WM_APP + 2017;
  WIN_TOGGLE_REPEAT     = WM_APP + 2018;
...
type
  TKeyOp = (koNone,
            ...
            koPanRight, koPanUp, koPanDn, koRotateR, koRotateL, koFullscreen, koZoomReset, koGreaterWindow, koToggleControls, koRunF10,
            koRunF11, koRunF12, koToggleProgressBar, koCentreWindow, koMinimizeWindow, koDeleteCurrentItem, koRenameFile, koSpeedUp, koSpeedDn, koSpeedReset,
