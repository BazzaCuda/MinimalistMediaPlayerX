...
function processKeyStroke(const mpv: TMPVBasePlayer; const aKey: word; const aShiftState: TShiftState; const upDn: TKeyDirection): TKeyOp;
  ...
  begin
    ...
    case keyDn and keyIs(VK_UP) and NOT ctrl                              of TRUE: result := koNextFolder; end;
    case keyDn and keyIs(VK_DOWN) and NOT ctrl                            of TRUE: result := koPrevFolder; end;
    ...
    case keyUp and keyIs(S) and NOT ctrl                                  of TRUE: result := koSaveImage; end;
