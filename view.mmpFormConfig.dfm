  ...
  object pageControl: TPageControl
    ...
    object tsExternalApps: TTabSheet
      ...
      object Label29: TLabel
        ...
        Alignment = taCenter
        Caption = 
          'Up to 15 user folders can be set for moving your media files wit' +
          'h one keystroke.'#13#10'Each folder can either be the full path to a f' +
          'older or it can specify the name of a subfolder with a Base Fold' +
          'er'
      end
    end
