From the _External Apps_ tab of the Ctrl-**[\\]** [Config Dialog](ConfigDialog:External_Apps) you can define up to three external applications
...
- this is equivalent to you issuing a standard "Open with..." on that file
- for example, one of the applications might be the "Classic" version of MS Paint, which is still popular
- or you might prefer, and be adept with, GIMP or Photoshop, etc
