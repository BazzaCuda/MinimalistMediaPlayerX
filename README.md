...
_N.B. Some users have reported issues with the main window resizing itself several times on normal-size monitors, e.g. 1920 x 1080, until it eventually fits.
