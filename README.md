...
`MMP` (`v4.0.0`) released TODAY! Now with multiple delete methods (recycle, delete or shred) and playlist filtering to play only the images, audio or video on an entire drive.
