...
An all-in-one media player, with built-in image and thumbnail browser (with image manipulation), and a timeline editor for fast lossless editing of audio and video files.
