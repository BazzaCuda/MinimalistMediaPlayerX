...
begin
  case (key = VK_ESCAPE) and GS.userInput             of TRUE: EXIT; end; // close userInput without closing HelpFull on Config
  case (key = VK_ESCAPE) and GS.showingConfig         of TRUE: EXIT; end; // close Config without closing Help Full!
