...
const
  ...
  WM_PROGRESSBAR_CLICK   = WM_USER + 2014;
  WM_TICK                = WM_USER + 2015;
  WM_ADJUST_ASPECT_RATIO = WM_USER + 2016;
  WM_CENTRE_WINDOW       = WM_USER + 2017;
  WM_KEY_UP              = WM_USER + 2018;
  WM_CHECK_SCREEN_LIMITS = WM_USER + 2019;
  WM_SMALLER_WINDOW      = WM_USER + 2020;
  WM_PLAY_CURRENT_ITEM   = WM_USER + 2021;
  WM_SHOW_WINDOW         = WM_USER + 2022;
